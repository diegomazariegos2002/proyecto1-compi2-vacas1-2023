    ...
    def traducir(self, ts: TablaSimbolos) -> RetornoTraduccion:
        ...
        if self.nombreVar != None:
            ...
            if idSimbolo.tipoDato == TipoDato.CADENA:
                ...
                cadenaRetorno += consolaGlobal.genIf("{} < 97".format(tChar),consolaGlobal.genGoto2(lEscribirChar))
                cadenaRetorno += consolaGlobal.genIf("{} > 122".format(tChar),consolaGlobal.genGoto2(lEscribirChar))
                ...
                return RetornoTraduccion(valor=tCadNueva,
                                ...
                                tipoVariable=TipoVariable.NORMAL,
                                codigoTraducido= consolaGlobal.genComment("ToUpperCase {}".format(self.nombreVar))+cadenaRetorno)
